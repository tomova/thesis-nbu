...
BATCH_SIZE = 64
dataset = []
for atom_features, atom_positions, adjacency_matrix, _, dipole, _ in data:
...
for epoch in range(1000):
    ...
    with torch.no_grad():
        ...
        if avg_val_loss_mse < best_val_loss:
            ...
            torch.save(net.state_dict(), 'best_model_egnn_dipole_mse.pth')


# Testing
net.load_state_dict(torch.load('best_model_egnn_dipole_mse.pth'))
net.eval()
with torch.no_grad():
    test_loss_l1 = 0
    test_loss_mse = 0
